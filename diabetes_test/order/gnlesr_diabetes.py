...
# frame.to_csv("./1w.csv", index=False, header=False, sep=' ')
# frameb.to_csv("./1b.csv", index=False, header=False, sep=' ')
frame1.to_csv("./1label.csv", index=False, header=False, sep=' ')
frame2.to_csv("./1pre.csv", index=False, header=False, sep=' ')
# # diaacc.close()
