...
# frame.to_csv("./9w1.csv", index=False, header=False, sep=' ')
# frameb.to_csv("./9b3.csv", index=False, header=False, sep=' ')
# frame1.to_csv("./9label1.csv", index=False, header=False, sep=' ')
# frame2.to_csv("./9pre1.csv", index=False, header=False, sep=' ')
# # diaacc.close()
