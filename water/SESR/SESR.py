...
Fisa4 = f_s_a(Inputs[:, (6, 7)], 12, len(db))
...
frame1.to_csv("./para/data1.csv", index=False, header=False, sep=' ')
frame2.to_csv("./para/data2.csv", index=False, header=False, sep=' ')
frame3.to_csv("./para/data3.csv", index=False, header=False, sep=' ')
frame4.to_csv("./para/data4.csv", index=False, header=False, sep=' ')
frameb.to_csv("./para/datab.csv", index=False, header=False, sep=' ')
